...
pub(crate) const SOURCES: [(&str, &str); 46] = [
    (
    ...
    (
        ...
        include_str!("../../../runtime/csharp/Ferrule.Runtime/Json/FerruleJson.Contains.cs"),
    ),
    (
        "Runtime/Json/FerruleJson.DependentSchemas.cs",
        include_str!(
            "../../../runtime/csharp/Ferrule.Runtime/Json/FerruleJson.DependentSchemas.cs"
        ),
    ),
    (
    ...
    (
        ...
        include_str!(
            "../../../runtime/csharp/Ferrule.Runtime/Json/FerruleJson.PatternProperties.cs"
        ),
    ),
    (
    ...
    (
        ...
        include_str!(
            "../../../runtime/csharp/Ferrule.Runtime/Json/FerruleJson.PropertyDependencies.cs"
        ),
    ),
    (
        "Runtime/Json/FerruleJson.PropertyNames.cs",
        include_str!("../../../runtime/csharp/Ferrule.Runtime/Json/FerruleJson.PropertyNames.cs"),
    ),
    (
