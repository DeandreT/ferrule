...
use codegen::{
    ...
    ArtifactSetError, Binding, Expression, GeneratedFile, GeneratedSequence, InnerJoin,
    IterationOutput, IterationPlan, IterationSource, Program, ProgramValidationError, RuntimeValue,
    SequenceWindow, SortFilterOrder, TargetConstruction, TargetScope, validate_program,
};
...
fn render_source(program: &Program) -> Result<String, EmitError> {
    let mut source = String::from(
        "// Generated by ferrule. Do not edit.\n\
         use codegen_runtime::{\n\
             AggregateFunction, ExecutionContext, GeneratedItems, InnerJoinKey, InnerJoinStage,\n\
             Instance, RecursiveCollectPaths,\n\
