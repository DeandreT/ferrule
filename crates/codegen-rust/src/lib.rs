...
use codegen::{
    ...
    IterationPlan, IterationSource, Program, ProgramValidationError, RuntimeValue, SequenceWindow,
...
fn render_source(program: &Program) -> Result<String, EmitError> {
    let mut source = String::from(
        "// Generated by ferrule. Do not edit.\n\
         use codegen_runtime::{\n\
             AggregateFunction, ExecutionContext, GeneratedItems, Instance, RecursiveCollectPaths,\n\
