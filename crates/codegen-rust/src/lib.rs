...
use codegen::{
    ...
    ArtifactSetError, Binding, Expression, GeneratedFile, IterationOutput, IterationPlan, Program,
    ProgramValidationError, SequenceWindow, SortFilterOrder, TargetScope, validate_program,
};
...
fn render_source(program: &Program) -> Result<String, EmitError> {
    let mut source = String::from(
        "// Generated by ferrule. Do not edit.\n\
         use codegen_runtime::{\n\
             AggregateFunction, Instance, RuntimeError, ScalarType, ScopeContext, SequenceWindow,\n\
             SortDirection, Value, adapt_target_value, aggregate, apply_sequence_windows, call,\n\
             field, group, item_count, repeated, require_bool, scalar, sort_candidates,\n\
         };\n\n",
    );
    source.push_str(
