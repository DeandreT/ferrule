...
use codegen::{
    ...
    SortFilterOrder, TargetScope, validate_program,
};
...
fn render_source(program: &Program) -> Result<String, EmitError> {
    let mut source = String::from(
        "// Generated by ferrule. Do not edit.\n\
         use codegen_runtime::{\n\
             AggregateFunction, GeneratedItems, Instance, RuntimeError, ScalarType, ScopeContext,\n\
             ...
             require_bool, scalar, sort_candidates, tokenize, tokenize_by_length,\n\
         };\n\n",
    );
    source.push_str(
