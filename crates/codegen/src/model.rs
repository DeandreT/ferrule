...
impl ScalarFunction {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::Floor => "floor",
            Self::CreateGuid => "create_guid",
            Self::JsonParseField => "json_parse_field",
            Self::JsonSerializeObject => "json_serialize_object",
            ...
            Self::DurationFromParts => "duration_from_parts",
            ...
            Self::SqliteMultiply => "sqlite_multiply",
            Self::Divide => "divide",
            Self::Equal => "equal",
    ...
    pub fn from_name(name: &str) -> Option<Self> {
        match name {
            ...
            "create_guid" => Some(Self::CreateGuid),
            "json_parse_field" => Some(Self::JsonParseField),
            "json_serialize_object" => Some(Self::JsonSerializeObject),
            ...
            "duration_from_parts" => Some(Self::DurationFromParts),
            ...
            "format_datetime" => Some(Self::FormatDatetime),
            "format_time" => Some(Self::FormatTime),
            "datetime_add" => Some(Self::DatetimeAdd),
            "edifact_to_datetime" => Some(Self::EdifactToDatetime),
            "add" => Some(Self::Add),
            "subtract" => Some(Self::Subtract),
            "multiply" => Some(Self::Multiply),
            "sqlite_multiply" => Some(Self::SqliteMultiply),
