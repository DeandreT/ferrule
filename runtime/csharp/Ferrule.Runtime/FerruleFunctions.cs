...
public static partial class FerruleFunctions
{
    public static FerruleValue Call(string function, IReadOnlyList<FerruleValue> arguments)
    {
        ...
        return function switch
        {
            ...
            "duration_from_parts" => DurationFromParts(arguments),
            ...
            "format_date" => FormatDate(arguments),
            "format_datetime" => FormatDateTime(arguments),
            "format_time" => FormatTime(arguments),
            ...
            "sqlite_multiply" => SqliteMultiply(arguments),
