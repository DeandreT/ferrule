...
| Execution | Native interpreter, unified bounded host run options, ordered published-artifact reports, CLI, GUI, browser demo | Packaged runtime, raw-payload library/HTTP APIs, deterministic traces |
