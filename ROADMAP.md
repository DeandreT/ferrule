...
| Code generation | [Portable Rust and package-free C# libraries](docs/code-generation.md) with shared lowering, 56 scalar functions, typed failures and ordered failure rules, host runtime values, ordered value maps, static named inputs, cross-source lookups, expression-driven collection search, root-context static inner joins, multiple mapped outputs, scalar/group targets, exact whole-group copies, source/generated iteration, keyed/marker/block grouping, controls, aggregates, recursive-collect generated sequences, and generated-sequence reducers | Broaden toward interpreter parity, publish the Rust runtime, and consider optional XML-specific XSLT |
